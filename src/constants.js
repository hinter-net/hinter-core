...
// Heartbeats
export const HEARTBEAT_INTERVAL_IN_SECONDS = 5 * 60;

// Stale detection
export const STALENESS_CHECK_INTERVAL_IN_SECONDS = 2.5 * 60;
export const GRACE_PERIOD_IN_SECONDS_TO_MIRROR_OUTGOING_DRIVE = 30;
export const GRACE_PERIOD_IN_SECONDS_TO_RECEIVE_NEW_HEARTBEAT = 30;
